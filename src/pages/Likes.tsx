...
import { getLikerList, like, skip } from "../services/api";
...
export default function Likes(props: Props) {
    ...
    const init = async () => {
        try {
            const result = await getLikerList();
            ...
            <div style={styles.body}>
                ...
                <div style={styles.maincard}>
                    ...
                    <Container style={styles.footer}>
                        <Text variant="heading" style={{ fontFamily: 'Poppins-SemiBold' }}>
                            People who recently sent you a like appear here.
                        </Text>
                    </Container>
                </div>
            </div>
